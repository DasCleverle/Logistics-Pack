...
for "_i" from MINSTATUS to MAXSTATUS do {
    [_addonName, QGVAR(setStatus) + str _i, format[localize LSTRING(KEYBIND_SETSTATUS), _i], [_i] call FUNC(keybindSetStatus), "", [_i + 1, [true, false, false]]] call CBA_fnc_addKeybind;
};